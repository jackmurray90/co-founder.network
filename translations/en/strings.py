...
strings = {
  ...
  'job_paid': 'This job listing has been paid for until %s. Click <a target="_blank" href="/pages/payment/%d">here</a> to renew for another 30 days.',
  'job_unpaid': 'This job listing has not been paid for. Click <a target="_blank" href="/pages/payment/%d">here</a> to pay for a 30 day listing.',
